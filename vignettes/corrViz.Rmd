...
In addition to interactive plots, `corrViz` also provides numerous static plots. In Figures 12 to 15 we show a selection of options to display correlations on a grid. The plot types can be any of _square_, _circle_, _text_, or _pie_, which can be set via the `type` argument. The additional arguments are: 
...
In Figure 14, we set `type = 'pie'`. This plot shows pie charts where the filled in percetnage represents the correlation value.
...
```
<center>
<caption><span id="fig14:fig14">Figure 14: </span>Static pie-chart correlation plot.</caption>
</center>
